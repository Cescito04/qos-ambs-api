...
declare const QosambassadorsApiApplication_base: (new (...args: any[]) => {
    projectRoot: string;
...
export declare class QosambassadorsApiApplication extends QosambassadorsApiApplication_base {
    constructor(options?: ApplicationConfig);
    protected configureFileUpload(destination?: string): void;
    setupRootRedirect(): void;
}
